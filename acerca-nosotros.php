    	...
    	<div class="row">
        	<div class="col-md-12">
                ...
                <div class="description-section text-center">
                    <p>No veras reducidas tus ganancias por NO SHOWS</p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
            	<div class="Text-About">
                	<h3>Misión</h3>
<p>Proveer tecnología vanguardista e innovadora a hoteles para mejorar sus procesos internos e incrementar la satisfacción de sus clientes.</p>
<h3>Visión</h3>
